...
{
    /// <inheritdoc />
    public partial class EnumerationMultipleQuizRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enumeration_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enumeration_QuizId",
                table: "Enumeration",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Multiple_QuizId",
                table: "Multiple",
                column: "QuizId");
        }
